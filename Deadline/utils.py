...
def submitRaw(app,name,start,end,inputFilepath,outputPath,outputFiles,pluginArgs,submitArgs,
              shotgunData,mayaGUI=False,limit=None,priority=None):
    '''
    usage:
    ...
    if shotgunData:
        ...
        submitData+='ExtraInfo0='+str(shotgunData['task']['name'])+'\n'
        submitData+='ExtraInfo1='+str(shotgunData['project']['name'])+'\n'
        submitData+='ExtraInfo2='+str(shotgunData['entity']['name'])+'\n'
        submitData+='ExtraInfo3='+str(shotgunData['version'])+'\n'
        submitData+='ExtraInfo4=Version generated from Deadline\n'
        submitData+='ExtraInfo5='+str(shotgunData['login'])+'\n'
        
        submitData+='ExtraInfoKeyValue0=TaskId='+str(shotgunData['task']['id'])+'\n'
        submitData+='ExtraInfoKeyValue1=ProjectId='+str(shotgunData['project']['id'])+'\n'
        submitData+='ExtraInfoKeyValue2=EntityId='+str(shotgunData['entity']['id'])+'\n'
        submitData+='ExtraInfoKeyValue3=EntityType='+str(shotgunData['entity']['type'])+'\n'
